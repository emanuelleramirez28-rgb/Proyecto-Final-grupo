...
import com.mycompany.proyectoprogra.view.AgregarSucursalDialog;
...
public class SucursalController {
  ...
  private void agregarSucursal() {
    ...
    try {
        ...
        Frame owner =
                JOptionPane.getFrameForComponent(sucursalView);

        AgregarSucursalDialog dialog =
                new AgregarSucursalDialog(owner);
  ...
  private void editarSucursal() {
    ...
    int id =
            sucursalView.getSelectedSucursalId();
    ...
    try {
        ...
        Sucursal sucursal =
                sucursalDAO.obtenerSucursal(id);
        ...
        sucursalDAO.actualizarSucursal(
                sucursalEditada
        );
